    ...
    <div className="App">
      ...
      <div className="functions">
        ...
        <div>
          ...
          <h2>Components</h2>
          <p>
            Build encapsulated<br></br> components that manage<br></br> their
            state
          </p>
        </div>
        <div>
          ...
          <h2>Single-Way</h2>
          <p>
            A set of immutable values<br></br> are passed to the <br></br>
            components
          </p>
        </div>
        <div>
          ...
          <h2>JSX</h2>
          <p>
            Statically-typed, designed <br></br>to run on modern<br></br>{" "}
            browsers
          </p>
        </div>
      </div>
